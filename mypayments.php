...
<body>
	<div class="bodySection">
		...
		<div class="contentSection">
			<a href="myloans.php" style="float: right;"><button class="submitBtn">My Loans</button></a>
				...
				<div class="allData" style="width: 100%;">
					...
					<table>
						...
						<?php
							...
							$query = mysqli_query($connect,"SELECT * FROM payments WHERE farmer = '$keyCode' ORDER BY id DESC");
							$rowcount = 0;
