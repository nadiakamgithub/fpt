			...
			<div class="wrapContent">
				<div class="allData" style="width: 100%;">
					<div class="otherLinks">
						...
						<span onclick="window.location='orders-ca.php';" class="activePageLink">Cancelled</span>
					</div>
					<div class="heading">All sent orders data(Cancelled)</div>
					<table>
						<tr>
							<th></th>
							<th>Order Code</th>
						...
						<?php
							...
							$query = mysqli_query($connect,"SELECT * FROM orders WHERE status = 'Cancelled' ORDER BY ordercode DESC");
							$rowcount = 0;
