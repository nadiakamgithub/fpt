			...
			<div class="wrapContent">
				<div class="allData" style="width: 100%;">
					<div class="otherLinks">
						...
						<span onclick="window.location='orders-r.php';" class="activePageLink">Rejected</span> |
						<span onclick="window.location='orders-ca.php';">Cancelled</span>
					</div>
					<div class="heading">All sent orders data(Rejected)</div>
					<table>
						<tr>
							<th></th>
							<th>Order Code</th>
						...
						<?php
							...
							$query = mysqli_query($connect,"SELECT * FROM orders WHERE status = 'Rejected' ORDER BY ordercode DESC");
							$rowcount = 0;
