				...
				<div class="inputForm">
					...
					<?php
						if (isset($_GET['data'])) {
							...
							if ($data == 'success') {
								echo"<p class='errorMsg'>New product is added successfully.</p>";
							}elseif ($data == 'edited') {
								echo"<p class='errorMsg'>The product is edited successfully.</p>";
							}
						}
					?>
					<form method="POST" action="server.php">
						<input type="text" name="name" class="textInput" placeholder="Product name" required>
						<input type="text" name="price" onkeypress='return isNumber(event);' class="textInput" placeholder="Cost Price in Frw" required>
						<input type="text" name="sprice" onkeypress='return isNumber(event);' class="textInput" placeholder="Selling Price in Frw" required>
						<input type="text" name="measurement" class="textInput" placeholder="Measurement" required>
						<button class="submitBtn" name="addnewProduct">Add new</button>
					</form>
				</div>
				<div class="allData">
					...
					<table>
						<tr>
							...
							<th>Product name</th>
							<th>Measurement</th>
							<th>Cost Price in Frw</th>
							<th>Selling Price in Frw</th>
							<th>Stock</th>
							<th></th>
						</tr>
						<?php
						if(isset($_GET['keyCode'])){
								...
								$query = mysqli_query($connect,"SELECT * FROM product WHERE productname LIKE '%$keyCode%' OR price LIKE '%$keyCode%'");
							}else{
